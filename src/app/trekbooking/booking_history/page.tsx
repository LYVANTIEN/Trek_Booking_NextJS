...
const History = () => {
  ...
  return (
    <div>
        ...
        <div className="container pt-3">
          ...
          >
            <div className="mx-5 mt-4 mb-2">
              <div className="flex justify-between">
                <span className="font-semibold text-xl">khach san</span>
                ...
                >
                  <div className="row">
                    <div className="col-4 border-r border-gray">
                      ...
                      <div className="w-3/4 m-auto">hay</div>
                    </div>
                    <div
          ...
          <div className="row pt-6 pb-6">
            <div className="button-rate flex justify-end pr-16">
              <button className="rated" onClick={() => setShowRate(true)}>
                Rated
              </button>
      ...
      <Rates showRate={showRate} setShowRate={setShowRate} />
    </div>
  );
};
