...
const ListHotelImage = ({ params }: { params: { hotelId: string } }) => {
  const [showHotelImageCreate, setShowHotelImageCreate] =
  ...
  const [selectedImageHotelId, setSelectedImageHotelId] = useState<
    number | null
  >(null);
  ...
  const currentHotelImage = listHotelImage.slice(
    indexOfFirstHotelImage,
    indexOfLastHotelImage
  );
  ...
  return (
    <div className="relative">
                          ...
                          <td className="whitespace-nowrap px-6 py-4">
                            <div className="flex justify-center">
                              <img
                                ...
                                alt="Delete"
                                onClick={() =>
                                  handleImageClick(item.hotelImageId)
                                }
                              />
                              {showPopup &&
                                selectedImageHotelId === item.hotelImageId && (
                                  <div className="fixed inset-0 z-10 flex items-center justify-center">
                                    ...
                                    <div className="relative bg-white p-8 rounded-lg">
                                      <p className="color-black font-bold text-2xl">
                                        Do you want to delete Hotel Image 3D Id:{" "}
                                        {item.hotelImageId}?
                                      </p>
      ...
      <CreateHotelImage
        showHotelImageCreate={showHotelImageCreate}
        setShowHotelImageCreate={setShowHotelImageCreate}
        onCreate={handleCreateHotelImage}
        hotelId={hotelId}
        listHotelImage={listHotelImage.length}
      />
    </div>
  );
};
